...
#s(hash-table size 97 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("org-elpa" ("2021-05-21 14:03:50" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2021-05-21 14:03:51" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2021-05-21 14:03:51" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "el-get" ("2021-05-21 14:03:51" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2021-05-21 14:03:51" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "straight" ("2021-05-21 14:03:51" ("emacs") (:type git :host github :repo "raxod502/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "use-package" ("2021-05-21 14:03:51" ("emacs" "bind-key") (:type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package" :package "use-package" :local-repo "use-package")) "bind-key" ("2021-05-21 14:03:51" nil (:flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :package "bind-key" :local-repo "use-package" :type git :repo "jwiegley/use-package" :host github)) "async" ("2021-05-21 14:03:51" ("emacs") (:type git :flavor melpa :host github :repo "jwiegley/emacs-async" :package "async" :local-repo "emacs-async")) "aio" ("2021-05-21 14:03:51" ("emacs") (:type git :flavor melpa :files ("aio.el" "README.md" "UNLICENSE" "aio-pkg.el") :host github :repo "skeeto/emacs-aio" :package "aio" :local-repo "emacs-aio")) "s" ("2021-05-21 14:03:51" nil (:type git :flavor melpa :files ("s.el" "s-pkg.el") :host github :repo "magnars/s.el" :package "s" :local-repo "s.el")) "dash" ("2021-05-21 14:03:51" ("emacs") (:type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "no-littering" ("2021-05-21 14:03:51" ("cl-lib") (:type git :flavor melpa :host github :repo "emacscollective/no-littering" :package "no-littering" :local-repo "no-littering")) "format-all" ("2021-05-21 14:03:51" ("emacs" "inheritenv" "language-id") (:type git :flavor melpa :host github :repo "lassik/emacs-format-all-the-code" :package "format-all" :local-repo "emacs-format-all-the-code")) "inheritenv" ("2021-05-21 14:03:51" ("emacs") (:type git :flavor melpa :host github :repo "purcell/inheritenv" :package "inheritenv" :local-repo "inheritenv")) "language-id" ("2021-05-21 14:03:51" ("emacs" "cl-lib") (:type git :flavor melpa :host github :repo "lassik/emacs-language-id" :package "language-id" :local-repo "emacs-language-id")) "magit" ("2021-05-21 14:03:51" ("emacs" "dash" "git-commit" "transient" "with-editor") (:flavor melpa :files ("lisp/magit" "lisp/magit*.el" "lisp/git-rebase.el" "Documentation/magit.texi" "Documentation/AUTHORS.md" "LICENSE" (:exclude "lisp/magit-libgit.el") "magit-pkg.el") :package "magit" :local-repo "magit" :type git :repo "magit/magit" :host github)) "git-commit" ("2021-05-21 14:03:51" ("emacs" "dash" "transient" "with-editor") (:flavor melpa :files ("lisp/git-commit.el" "git-commit-pkg.el") :package "git-commit" :local-repo "magit" :type git :repo "magit/magit" :host github)) "transient" ("2021-05-21 14:03:51" ("emacs") (:type git :flavor melpa :files ("lisp/*.el" "docs/transient.texi" "transient-pkg.el") :host github :repo "magit/transient" :package "transient" :local-repo "transient")) "with-editor" ("2021-05-21 14:03:51" ("emacs") (:type git :flavor melpa :host github :repo "magit/with-editor" :package "with-editor" :local-repo "with-editor")) "magit-todos" ("2021-05-21 14:03:52" ("emacs" "async" "dash" "f" "hl-todo" "magit" "pcre2el" "s") (:type git :flavor melpa :host github :repo "alphapapa/magit-todos" :package "magit-todos" :local-repo "magit-todos")) "f" ("2021-05-21 14:03:51" ("s" "dash") (:type git :flavor melpa :files ("f.el" "f-pkg.el") :host github :repo "rejeep/f.el" :package "f" :local-repo "f.el")) "hl-todo" ("2021-05-21 14:03:52" ("emacs") (:type git :flavor melpa :host github :repo "tarsius/hl-todo" :package "hl-todo" :local-repo "hl-todo")) "pcre2el" ("2021-05-21 14:03:52" ("emacs" "cl-lib") (:type git :flavor melpa :files ("pcre2el.el" "pcre2el-pkg.el") :host github :repo "joddie/pcre2el" :package "pcre2el" :local-repo "pcre2el")) "git-messenger" ("2021-05-21 14:03:52" ("emacs" "popup") (:type git :flavor melpa :host github :repo "emacsorphanage/git-messenger" :package "git-messenger" :local-repo "git-messenger")) "popup" ("2021-05-21 14:03:52" ("emacs") (:type git :flavor melpa :files ("popup.el" "popup-pkg.el") :host github :repo "auto-complete/popup-el" :package "popup" :local-repo "popup-el")) "lsp-mode" ("2021-05-21 14:03:52" ("emacs" "dash" "f" "ht" "spinner" "markdown-mode" "lv") (:type git :flavor melpa :files (:defaults "clients/*.el" "lsp-mode-pkg.el") :host github :repo "emacs-lsp/lsp-mode" :package "lsp-mode" :local-repo "lsp-mode")) "ht" ("2021-05-21 14:03:52" ("dash") (:type git :flavor melpa :files ("ht.el" "ht-pkg.el") :host github :repo "Wilfred/ht.el" :package "ht" :local-repo "ht.el")) "spinner" ("2021-05-21 14:03:52" ("emacs") (:type git :host github :repo "emacs-straight/spinner" :files ("*" (:exclude ".git")) :package "spinner" :local-repo "spinner")) "markdown-mode" ("2021-05-21 14:03:52" ("emacs") (:type git :flavor melpa :host github :repo "jrblevin/markdown-mode" :package "markdown-mode" :local-repo "markdown-mode")) "lv" ("2021-05-21 14:03:51" nil (:flavor melpa :files ("lv.el" "lv-pkg.el") :package "lv" :local-repo "hydra" :type git :repo "abo-abo/hydra" :host github)) "lsp-ui" ("2021-05-21 14:03:52" ("emacs" "dash" "lsp-mode" "markdown-mode") (:type git :flavor melpa :files (:defaults "lsp-ui-doc.html" "resources" "lsp-ui-pkg.el") :host github :repo "emacs-lsp/lsp-ui" :package "lsp-ui" :local-repo "lsp-ui")) "company" ("2021-05-21 14:03:52" ("emacs") (:type git :flavor melpa :files (:defaults "icons" "company-pkg.el") :host github :repo "company-mode/company-mode" :package "company" :local-repo "company-mode")) "company-box" ("2021-05-21 14:03:52" ("emacs" "dash" "dash-functional" "company" "frame-local") (:type git :flavor melpa :files (:defaults "images" "company-box-pkg.el") :host github :repo "sebastiencs/company-box" :package "company-box" :local-repo "company-box")) "dash-functional" ("2021-05-21 14:03:51" ("dash") (:flavor melpa :files ("dash-functional.el" "dash-functional-pkg.el") :package "dash-functional" :local-repo "dash.el" :type git :repo "magnars/dash.el" :host github)) "frame-local" ("2021-05-21 14:03:52" ("emacs") (:type git :flavor melpa :host github :repo "sebastiencs/frame-local" :package "frame-local" :local-repo "frame-local")) "evil-leader" ("2021-05-21 14:03:51" ("evil") (:type git :flavor melpa :host github :repo "cofi/evil-leader" :package "evil-leader" :local-repo "evil-leader")) "evil" ("2021-05-21 14:03:51" ("emacs" "goto-chg" "cl-lib") (:type git :flavor melpa :files (:defaults "doc/build/texinfo/evil.texi" (:exclude "evil-test-helpers.el") "evil-pkg.el") :host github :repo "emacs-evil/evil" :package "evil" :local-repo "evil")) "goto-chg" ("2021-05-21 14:03:51" ("emacs") (:type git :flavor melpa :host github :repo "emacs-evil/goto-chg" :package "goto-chg" :local-repo "goto-chg")) "evil-org" ("2021-05-21 14:03:51" ("emacs" "evil") (:type git :flavor melpa :host github :repo "Somelauw/evil-org-mode" :package "evil-org" :local-repo "evil-org-mode")) "evil-collection" ("2021-05-21 14:03:51" ("emacs" "evil" "annalist") (:type git :flavor melpa :files (:defaults "modes" "evil-collection-pkg.el") :host github :repo "emacs-evil/evil-collection" :package "evil-collection" :local-repo "evil-collection")) "annalist" ("2021-05-21 14:03:51" ("emacs" "cl-lib") (:type git :flavor melpa :host github :repo "noctuid/annalist.el" :package "annalist" :local-repo "annalist.el")) "vertico" ("2021-05-21 14:03:51" ("emacs") (:type git :host github :repo "emacs-straight/vertico" :files ("*" (:exclude ".git")) :package "vertico" :local-repo "vertico")) "orderless" ("2021-05-21 14:03:51" ("emacs") (:type git :flavor melpa :host github :repo "oantolin/orderless" :package "orderless" :local-repo "orderless")) "good-scroll" ("2021-05-21 14:03:51" ("emacs") (:type git :flavor melpa :host github :repo "io12/good-scroll.el" :package "good-scroll" :local-repo "good-scroll.el")) "counsel" ("2021-05-21 12:54:51" ("emacs" "ivy" "swiper") (:type git :flavor melpa :files ("counsel.el" "counsel-pkg.el") :host github :repo "abo-abo/swiper" :package "counsel" :local-repo "swiper")) "ivy" ("2021-05-21 12:54:51" ("emacs") (:flavor melpa :files (:defaults (:exclude "swiper.el" "counsel.el" "ivy-hydra.el" "ivy-avy.el") "doc/ivy-help.org" "ivy-pkg.el") :package "ivy" :local-repo "swiper" :type git :repo "abo-abo/swiper" :host github)) "swiper" ("2021-05-21 12:54:51" ("emacs" "ivy") (:flavor melpa :files ("swiper.el" "swiper-pkg.el") :package "swiper" :local-repo "swiper" :type git :repo "abo-abo/swiper" :host github)) "amx" ("2021-05-21 12:54:52" ("emacs" "s") (:type git :flavor melpa :host github :repo "DarwinAwardWinner/amx" :package "amx" :local-repo "amx")) "all-the-icons-ivy-rich" ("2021-05-21 12:54:52" ("emacs" "ivy-rich" "all-the-icons") (:type git :flavor melpa :host github :repo "seagle0128/all-the-icons-ivy-rich" :package "all-the-icons-ivy-rich" :local-repo "all-the-icons-ivy-rich")) "ivy-rich" ("2021-05-21 12:54:52" ("emacs" "ivy") (:type git :flavor melpa :files ("*.el" "ivy-rich-pkg.el") :host github :repo "Yevgnen/ivy-rich" :package "ivy-rich" :local-repo "ivy-rich")) "all-the-icons" ("2021-05-21 12:54:52" ("emacs") (:type git :flavor melpa :files (:defaults "data" "all-the-icons-pkg.el") :host github :repo "domtronn/all-the-icons.el" :package "all-the-icons" :local-repo "all-the-icons.el")) "flx" ("2021-05-21 12:29:57" ("cl-lib") (:type git :flavor melpa :files ("flx.el" "flx-pkg.el") :host github :repo "lewang/flx" :package "flx" :local-repo "flx")) "ivy-posframe" ("2021-05-21 12:32:08" ("emacs" "posframe" "ivy") (:type git :flavor melpa :host github :repo "tumashu/ivy-posframe" :package "ivy-posframe" :local-repo "ivy-posframe")) "posframe" ("2021-05-21 14:03:51" ("emacs") (:type git :flavor melpa :host github :repo "tumashu/posframe" :package "posframe" :local-repo "posframe")) "mini-frame" ("2021-05-21 14:03:51" ("emacs") (:type git :flavor melpa :host github :repo "muffinmad/emacs-mini-frame" :package "mini-frame" :local-repo "emacs-mini-frame")) "corfu" ("2021-05-21 14:03:51" ("emacs") (:host github :repo "minad/corfu" :files ("*" (:exclude ".git")) :package "corfu" :type git :local-repo "corfu")) "consult" ("2021-05-21 14:03:51" ("emacs") (:type git :flavor melpa :files (:defaults (:exclude "consult-flycheck.el") "consult-pkg.el") :host github :repo "minad/consult" :package "consult" :local-repo "consult")) "marginalia" ("2021-05-21 14:03:51" ("emacs") (:type git :flavor melpa :host github :repo "minad/marginalia" :package "marginalia" :local-repo "marginalia")) "embark" ("2021-05-21 14:03:51" ("emacs") (:type git :flavor melpa :files ("embark.el" "embark.texi" "embark-pkg.el") :host github :repo "oantolin/embark" :package "embark" :local-repo "embark")) "which-key" ("2021-05-21 14:03:51" ("emacs") (:type git :flavor melpa :host github :repo "justbur/emacs-which-key" :package "which-key" :local-repo "emacs-which-key")) "which-key-posframe" ("2021-05-21 14:03:51" ("emacs" "posframe" "which-key") (:type git :flavor melpa :host github :repo "yanghaoxie/which-key-posframe" :package "which-key-posframe" :local-repo "which-key-posframe")) "bufler" ("2021-05-21 14:03:51" ("emacs" "dash" "dash-functional" "f" "pretty-hydra" "magit-section") (:type git :flavor melpa :files (:defaults (:exclude "helm-bufler.el") "bufler-pkg.el") :host github :repo "alphapapa/bufler.el" :package "bufler" :local-repo "bufler.el")) "pretty-hydra" ("2021-05-21 14:03:51" ("hydra" "s" "dash" "emacs") (:type git :flavor melpa :files ("pretty-hydra.el" "pretty-hydra-pkg.el") :host github :repo "jerrypnz/major-mode-hydra.el" :package "pretty-hydra" :local-repo "major-mode-hydra.el")) "hydra" ("2021-05-21 14:03:51" ("cl-lib" "lv") (:type git :flavor melpa :files (:defaults (:exclude "lv.el") "hydra-pkg.el") :host github :repo "abo-abo/hydra" :package "hydra" :local-repo "hydra")) "magit-section" ("2021-05-21 14:03:51" ("emacs" "dash") (:type git :flavor melpa :files ("lisp/magit-section.el" "Documentation/magit-section.texi" "magit-section-pkg.el") :host github :repo "magit/magit" :package "magit-section" :local-repo "magit"))))
...
(fn FILE)" nil nil) (register-definition-prefixes "no-littering" '("no-littering-")) (provide 'no-littering-autoloads)) "inheritenv" ((inheritenv inheritenv-autoloads) (autoload 'inheritenv-apply "inheritenv" "Apply FUNC such that the environment it sees will match the current value.
...
(fn WORKTREE PATH)" t nil) (register-definition-prefixes "magit-worktree" '("magit-")) (provide 'magit-autoloads)) "f" ((f f-autoloads) (register-definition-prefixes "f" '("f-")) (provide 'f-autoloads)) "hl-todo" ((hl-todo hl-todo-autoloads) (autoload 'hl-todo-mode "hl-todo" "Highlight TODO and similar keywords in comments and strings.
...
(fn KEYWORD)" t nil) (register-definition-prefixes "hl-todo" '("hl-todo-")) (provide 'hl-todo-autoloads)) "pcre2el" ((pcre2el pcre2el-autoloads) (defvar pcre-mode nil "Non-nil if PCRE mode is enabled.
...
(fn &optional ARG)" t nil) (register-definition-prefixes "company-box" '("company-box-")) (register-definition-prefixes "company-box-doc" '("company-box-")) (register-definition-prefixes "company-box-icons" '("company-box-icons-")) (provide 'company-box-autoloads)) "goto-chg" ((goto-chg-autoloads goto-chg) (autoload 'goto-last-change "goto-chg" "Go to the point where the last edit was made in the current buffer.
...
(fn &optional ARG)" t nil) (register-definition-prefixes "evil-org" '("evil-org-")) (register-definition-prefixes "evil-org-agenda" '("evil-org-agenda-set-keys")) (provide 'evil-org-autoloads)) "annalist" ((annalist-autoloads annalist) (autoload 'annalist-record "annalist" "In the store for ANNALIST, TYPE, and LOCAL, record RECORD.
...
(fn &optional MODES)" t nil) (register-definition-prefixes "evil-collection" '("evil-collection-")) (provide 'evil-collection-autoloads)) "vertico" ((vertico vertico-autoloads) (defvar vertico-mode nil "Non-nil if Vertico mode is enabled.
...
If called interactively, toggle `Vertico mode'.  If the prefix
argument is positive, enable the mode, and if it is zero or
negative, disable the mode.
...
If called interactively, toggle `Good-Scroll mode'.  If the
prefix argument is positive, enable the mode, and if it is zero
or negative, disable the mode.
...
(fn &optional ARG)" t nil) (register-definition-prefixes "counsel" '("counsel-" "ivy-function-called-at-point" "tmm-km-list")) (provide 'counsel-autoloads)) "amx" ((amx amx-autoloads) (defvar amx-mode nil "Non-nil if Amx mode is enabled.
...
If called interactively, toggle `Amx mode'.  If the prefix
argument is positive, enable the mode, and if it is zero or
negative, disable the mode.
...
(fn &optional REINIT)" t nil) (register-definition-prefixes "amx" '("amx-")) (provide 'amx-autoloads)) "ivy-rich" ((ivy-rich-autoloads ivy-rich) (defvar ivy-rich-mode nil "Non-nil if Ivy-Rich mode is enabled.
...
(fn &optional ARG)" t nil) (register-definition-prefixes "ivy-rich" '("ivy-rich-")) (provide 'ivy-rich-autoloads)) "all-the-icons" ((all-the-icons-autoloads all-the-icons-faces all-the-icons) (autoload 'all-the-icons-icon-for-dir "all-the-icons" "Get the formatted icon for DIR.
...
(fn &optional ARG FAMILY)" t nil) (register-definition-prefixes "all-the-icons" '("all-the-icons-")) (provide 'all-the-icons-autoloads)) "all-the-icons-ivy-rich" ((all-the-icons-ivy-rich all-the-icons-ivy-rich-autoloads) (defvar all-the-icons-ivy-rich-mode nil "Non-nil if All-The-Icons-Ivy-Rich mode is enabled.
...
If called interactively, toggle `All-The-Icons-Ivy-Rich mode'.
If the prefix argument is positive, enable the mode, and if it is
zero or negative, disable the mode.
...
(fn &optional ARG)" t nil) (autoload 'all-the-icons-ivy-rich-reload "all-the-icons-ivy-rich" "Reload `all-the-icons-ivy-rich'." t nil) (register-definition-prefixes "all-the-icons-ivy-rich" '("all-the-icons-ivy-rich-")) (provide 'all-the-icons-ivy-rich-autoloads)) "flx" ((flx flx-autoloads) (register-definition-prefixes "flx" '("flx-")) (provide 'flx-autoloads)) "posframe" ((posframe posframe-autoloads) (autoload 'posframe-workable-p "posframe" "Test posframe workable status." nil nil) (autoload 'posframe-show "posframe" "Pop up a posframe and show STRING at POSITION.
...
(fn &optional ARG)" t nil) (register-definition-prefixes "ivy-posframe" '("ivy-posframe-")) (provide 'ivy-posframe-autoloads)) "mini-frame" ((mini-frame mini-frame-autoloads) (defvar mini-frame-mode nil "Non-nil if Mini-Frame mode is enabled.
...
If called interactively, toggle `Mini-Frame mode'.  If the prefix
argument is positive, enable the mode, and if it is zero or
negative, disable the mode.
...
(fn &optional ARG)" t nil) (register-definition-prefixes "mini-frame" '("mini-frame-")) (provide 'mini-frame-autoloads)) "corfu" ((corfu-autoloads corfu) (autoload 'corfu-mode "corfu" "Completion Overlay Region FUnction

If called interactively, toggle `Corfu mode'.  If the prefix
argument is positive, enable the mode, and if it is zero or
negative, disable the mode.
...
buffer for each type of completion." t nil) (register-definition-prefixes "embark" '("embark-")) (provide 'embark-autoloads)) "which-key" ((which-key-autoloads which-key) (defvar which-key-mode nil "Non-nil if Which-Key mode is enabled.
...
(fn &optional ARG)" t nil) (register-definition-prefixes "which-key-posframe" '("which-key-")) (provide 'which-key-posframe-autoloads)) "hydra" ((hydra hydra-autoloads hydra-ox hydra-examples) (autoload 'defhydra "hydra" "Create a Hydra - a family of functions with prefix NAME.
...
`tab-bar-tabs-function'." (with-selected-frame (or frame (selected-frame)) (cl-labels ((tab-type (path) (if (equal path (frame-parameter nil 'bufler-workspace-path)) 'current-tab 'tab)) (path-first (path) (cl-typecase path (string (list path)) (list (if (car path) (list (car path)) (list (cadr path)))))) (workspace-to-tab (workspace &optional type) (-let* (((&plist :name :path) workspace)) (list (or type (tab-type path)) (cons 'name (car name)) (cons 'path path)))) (path-top-level (path) (pcase-exhaustive path (`(,(and first (guard (not first))) ,(and second (guard second)) \, _rest) (ignore first second) (cl-subseq path 0 2)) (`(,first \, _rest) (list first)))) (path-to-workspace (path) (list :name (path-first path) :path path))) (let* ((bufler-vc-refresh nil) (buffer-paths (bufler-group-tree-paths (bufler-buffers))) (group-paths (mapcar #'butlast buffer-paths)) (top-level-paths (mapcar #'path-top-level group-paths)) (top-level-workspaces (mapcar #'path-to-workspace top-level-paths)) (unique-top-level-workspaces (seq-uniq top-level-workspaces #'equal)) (tabs (mapcar #'workspace-to-tab unique-top-level-workspaces))) (unless (cl-loop with current-path = (frame-parameter nil 'bufler-workspace-path) for tab in tabs for tab-path = (alist-get 'path tab) thereis (equal tab-path current-path)) (push (list 'current-tab (cons 'name (bufler-format-path (frame-parameter nil 'bufler-workspace-path))) (cons 'path (frame-parameter nil 'bufler-workspace-path))) tabs)) tabs))))) (provide 'bufler-autoloads))))

#s(hash-table size 65 test eq rehash-size 1.5 rehash-threshold 0.8125 data (org-elpa #s(hash-table size 97 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 9 "melpa" nil "gnu-elpa-mirror" nil "el-get" nil "emacsmirror-mirror" nil "straight" nil "use-package" nil "bind-key" nil "async" nil "aio" nil "cl-lib" nil "s" nil "dash" nil "no-littering" nil "format-all" nil "inheritenv" nil "language-id" nil "magit" nil "git-commit" nil "transient" nil "with-editor" nil "magit-todos" nil "f" nil "hl-todo" nil "pcre2el" nil "git-messenger" nil "popup" nil "lsp-mode" nil "ht" nil "spinner" nil "markdown-mode" nil "lv" nil "lsp-ui" nil "company" nil "company-box" nil "dash-functional" nil "frame-local" nil "evil-leader" nil "evil" nil "goto-chg" nil "evil-org" nil "evil-collection" nil "annalist" nil "vertico" nil "orderless" nil "savehist" nil "mwheel" nil "pixel-scroll" nil "good-scroll" nil "counsel" nil "ivy" nil "swiper" nil "amx" nil "all-the-icons-ivy-rich" nil "ivy-rich" nil "all-the-icons" nil "flx" nil "ivy-posframe" nil "posframe" nil "mini-frame" nil "corfu" nil "consult" nil "marginalia" nil "embark" nil "which-key" nil "which-key-posframe" nil "bufler" nil "pretty-hydra" nil "hydra" nil "magit-section" nil "bufler-mode" nil)) melpa #s(hash-table size 97 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "gnu-elpa-mirror" nil "el-get" (el-get :type git :flavor melpa :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :host github :repo "dimitri/el-get") "emacsmirror-mirror" nil "straight" nil "use-package" (use-package :type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package") "bind-key" (bind-key :type git :flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :host github :repo "jwiegley/use-package") "async" (async :type git :flavor melpa :host github :repo "jwiegley/emacs-async") "aio" (aio :type git :flavor melpa :files ("aio.el" "README.md" "UNLICENSE" "aio-pkg.el") :host github :repo "skeeto/emacs-aio") "cl-lib" nil "s" (s :type git :flavor melpa :files ("s.el" "s-pkg.el") :host github :repo "magnars/s.el") "dash" (dash :type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el") "no-littering" (no-littering :type git :flavor melpa :host github :repo "emacscollective/no-littering") "format-all" (format-all :type git :flavor melpa :host github :repo "lassik/emacs-format-all-the-code") "inheritenv" (inheritenv :type git :flavor melpa :host github :repo "purcell/inheritenv") "language-id" (language-id :type git :flavor melpa :host github :repo "lassik/emacs-language-id") "magit" (magit :type git :flavor melpa :files ("lisp/magit" "lisp/magit*.el" "lisp/git-rebase.el" "Documentation/magit.texi" "Documentation/AUTHORS.md" "LICENSE" (:exclude "lisp/magit-libgit.el") "magit-pkg.el") :host github :repo "magit/magit") "git-commit" (git-commit :type git :flavor melpa :files ("lisp/git-commit.el" "git-commit-pkg.el") :host github :repo "magit/magit") "transient" (transient :type git :flavor melpa :files ("lisp/*.el" "docs/transient.texi" "transient-pkg.el") :host github :repo "magit/transient") "with-editor" (with-editor :type git :flavor melpa :host github :repo "magit/with-editor") "magit-todos" (magit-todos :type git :flavor melpa :host github :repo "alphapapa/magit-todos") "f" (f :type git :flavor melpa :files ("f.el" "f-pkg.el") :host github :repo "rejeep/f.el") "hl-todo" (hl-todo :type git :flavor melpa :host github :repo "tarsius/hl-todo") "pcre2el" (pcre2el :type git :flavor melpa :files ("pcre2el.el" "pcre2el-pkg.el") :host github :repo "joddie/pcre2el") "git-messenger" (git-messenger :type git :flavor melpa :host github :repo "emacsorphanage/git-messenger") "popup" (popup :type git :flavor melpa :files ("popup.el" "popup-pkg.el") :host github :repo "auto-complete/popup-el") "lsp-mode" (lsp-mode :type git :flavor melpa :files (:defaults "clients/*.el" "lsp-mode-pkg.el") :host github :repo "emacs-lsp/lsp-mode") "ht" (ht :type git :flavor melpa :files ("ht.el" "ht-pkg.el") :host github :repo "Wilfred/ht.el") "spinner" nil "markdown-mode" (markdown-mode :type git :flavor melpa :host github :repo "jrblevin/markdown-mode") "lv" (lv :type git :flavor melpa :files ("lv.el" "lv-pkg.el") :host github :repo "abo-abo/hydra") "lsp-ui" (lsp-ui :type git :flavor melpa :files (:defaults "lsp-ui-doc.html" "resources" "lsp-ui-pkg.el") :host github :repo "emacs-lsp/lsp-ui") "company" (company :type git :flavor melpa :files (:defaults "icons" "company-pkg.el") :host github :repo "company-mode/company-mode") "company-box" (company-box :type git :flavor melpa :files (:defaults "images" "company-box-pkg.el") :host github :repo "sebastiencs/company-box") "dash-functional" (dash-functional :type git :flavor melpa :files ("dash-functional.el" "dash-functional-pkg.el") :host github :repo "magnars/dash.el") "frame-local" (frame-local :type git :flavor melpa :host github :repo "sebastiencs/frame-local") "evil-leader" (evil-leader :type git :flavor melpa :host github :repo "cofi/evil-leader") "evil" (evil :type git :flavor melpa :files (:defaults "doc/build/texinfo/evil.texi" (:exclude "evil-test-helpers.el") "evil-pkg.el") :host github :repo "emacs-evil/evil") "goto-chg" (goto-chg :type git :flavor melpa :host github :repo "emacs-evil/goto-chg") "evil-org" (evil-org :type git :flavor melpa :host github :repo "Somelauw/evil-org-mode") "evil-collection" (evil-collection :type git :flavor melpa :files (:defaults "modes" "evil-collection-pkg.el") :host github :repo "emacs-evil/evil-collection") "annalist" (annalist :type git :flavor melpa :host github :repo "noctuid/annalist.el") "vertico" nil "orderless" (orderless :type git :flavor melpa :host github :repo "oantolin/orderless") "savehist" nil "mwheel" nil "pixel-scroll" nil "good-scroll" (good-scroll :type git :flavor melpa :host github :repo "io12/good-scroll.el") "counsel" (counsel :type git :flavor melpa :files ("counsel.el" "counsel-pkg.el") :host github :repo "abo-abo/swiper") "ivy" (ivy :type git :flavor melpa :files (:defaults (:exclude "swiper.el" "counsel.el" "ivy-hydra.el" "ivy-avy.el") "doc/ivy-help.org" "ivy-pkg.el") :host github :repo "abo-abo/swiper") "swiper" (swiper :type git :flavor melpa :files ("swiper.el" "swiper-pkg.el") :host github :repo "abo-abo/swiper") "amx" (amx :type git :flavor melpa :host github :repo "DarwinAwardWinner/amx") "all-the-icons-ivy-rich" (all-the-icons-ivy-rich :type git :flavor melpa :host github :repo "seagle0128/all-the-icons-ivy-rich") "ivy-rich" (ivy-rich :type git :flavor melpa :files ("*.el" "ivy-rich-pkg.el") :host github :repo "Yevgnen/ivy-rich") "all-the-icons" (all-the-icons :type git :flavor melpa :files (:defaults "data" "all-the-icons-pkg.el") :host github :repo "domtronn/all-the-icons.el") "flx" (flx :type git :flavor melpa :files ("flx.el" "flx-pkg.el") :host github :repo "lewang/flx") "ivy-posframe" (ivy-posframe :type git :flavor melpa :host github :repo "tumashu/ivy-posframe") "posframe" (posframe :type git :flavor melpa :host github :repo "tumashu/posframe") "mini-frame" (mini-frame :type git :flavor melpa :host github :repo "muffinmad/emacs-mini-frame") "corfu" nil "consult" (consult :type git :flavor melpa :files (:defaults (:exclude "consult-flycheck.el") "consult-pkg.el") :host github :repo "minad/consult") "marginalia" (marginalia :type git :flavor melpa :host github :repo "minad/marginalia") "embark" (embark :type git :flavor melpa :files ("embark.el" "embark.texi" "embark-pkg.el") :host github :repo "oantolin/embark") "which-key" (which-key :type git :flavor melpa :host github :repo "justbur/emacs-which-key") "which-key-posframe" (which-key-posframe :type git :flavor melpa :host github :repo "yanghaoxie/which-key-posframe") "bufler" (bufler :type git :flavor melpa :files (:defaults (:exclude "helm-bufler.el") "bufler-pkg.el") :host github :repo "alphapapa/bufler.el") "pretty-hydra" (pretty-hydra :type git :flavor melpa :files ("pretty-hydra.el" "pretty-hydra-pkg.el") :host github :repo "jerrypnz/major-mode-hydra.el") "hydra" (hydra :type git :flavor melpa :files (:defaults (:exclude "lv.el") "hydra-pkg.el") :host github :repo "abo-abo/hydra") "magit-section" (magit-section :type git :flavor melpa :files ("lisp/magit-section.el" "Documentation/magit-section.texi" "magit-section-pkg.el") :host github :repo "magit/magit") "bufler-mode" nil)) gnu-elpa-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 3 "emacsmirror-mirror" nil "straight" nil "cl-lib" nil "spinner" (spinner :type git :host github :repo "emacs-straight/spinner" :files ("*" (:exclude ".git"))) "vertico" (vertico :type git :host github :repo "emacs-straight/vertico" :files ("*" (:exclude ".git"))) "savehist" nil "mwheel" nil "pixel-scroll" nil "corfu" (corfu :type git :host github :repo "emacs-straight/corfu" :files ("*" (:exclude ".git"))) "bufler-mode" nil)) el-get #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 1 "emacsmirror-mirror" nil "straight" nil "cl-lib" nil "savehist" nil "mwheel" nil "pixel-scroll" nil "bufler-mode" nil)) emacsmirror-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "straight" (straight :type git :host github :repo "emacsmirror/straight") "cl-lib" nil "savehist" nil "mwheel" nil "pixel-scroll" nil "bufler-mode" nil))))

("org-elpa" "melpa" "gnu-elpa-mirror" "el-get" "emacsmirror-mirror" "straight" "emacs" "use-package" "bind-key" "async" "aio" "cl-lib" "s" "dash" "no-littering" "vertico" "corfu" "orderless" "savehist" "consult" "marginalia" "embark" "mini-frame" "which-key" "which-key-posframe" "posframe" "bufler" "dash-functional" "f" "pretty-hydra" "hydra" "lv" "magit-section" "good-scroll" "evil-leader" "evil" "goto-chg" "evil-collection" "annalist" "evil-org" "format-all" "inheritenv" "language-id" "magit" "git-commit" "transient" "with-editor" "magit-todos" "hl-todo" "pcre2el" "git-messenger" "popup" "lsp-mode" "ht" "spinner" "markdown-mode" "lsp-ui" "company" "company-box" "frame-local")
