...
(custom-set-variables
 ...
 '(org-agenda-files
   '("~/documents/supervisor/guide.org" "~/documents/supervisor/stack.org" "~/documents/supervisor/tasks.org"))
...
(custom-set-faces
 ...
 '(org-level-1 ((t (:inherit default :weight bold :foreground "#ECEFF4" :font "ETBembo" :height 1.55))))
 '(org-level-2 ((t (:inherit default :weight bold :foreground "#ECEFF4" :font "ETBembo" :height 1.4))))
