...
** Bullets
   ...
   #+begin_src emacs-lisp
     ...
     (setq org-superstar-todo-bullet-alist '(("TODO" . 9744) ("BLOCKED" . 9202) ("PROGRESS" . 8885) ("DONE" . 9745) ("PAL" . 9745) ("IDEA" . 1422) ("NOTE" . 9738)))
   #+end_src
** Folded
    ...
    (setq org-capture-templates
        '(("t" "Todo" entry (file "~/documents/org/tasks.org")
          ...
          ("n" "Note" entry (file "~/documents/org/notes.org")
           "* NOTE %?\n%U" :empty-lines 1)
          ("q" "Note" entry (file "~/documents/org/quotes.org")
           "* QUOTE %?\n%U" :empty-lines 1)
        ))
...
#+begin_src emacs-lisp
  ...
  (setq org-roam-graph-exclude-matcher '("tasks" "archive" "Schule"))
#+end_src
** Writing
...
#+begin_src emacs-lisp
  ...
  (define-key org-mode-map (kbd "C-c j") 'display-line-numbers-mode)
#+end_src
** Hoth
#+begin_src emacs-lisp
