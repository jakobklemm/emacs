...
*** Smex
		...
		#+end_src
** Helm
Use Helm instead of =ido= or =ivy=.
#+begin_src emacs-lisp
(use-package helm)
...
*** States
   ...
   #+begin_src emacs-lisp
     (setq org-todo-keywords
           '((sequence "TODO(t)" "PROGRESS(t)" "BLOCKED(b)" "|" "DONE(d)" "PAL(p)")
           ...
           ((org-super-agenda-groups
             '(
               (:name "Important"
                  ...
                  :priority "A"
                  :time-grid t
                  ;; :face (:background "#9e953a")
                  :order 0
                  )
           (:name "Schule"
                  :tag ("schule" "prüfung")
                  ;; :face (:background "#11a224")
                  :order 1
                  )
           (:name "Personal"
                  :tag ("data" "home" "personal")
                  ;; :face (:background "#13a1da")
                  :order 1
                  )
           (:name "Projects"
                  :tag ("erebos" "warrick")
                  ;; :face (:background "#39abaf")
                  :order 2
                  )
           (:priority<= "B"
                        :order 3
