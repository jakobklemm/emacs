...
#+end_src
*** View
Use [[https:github.com/kiwanami/emacs-calfw][cfw]] for a better calendar view.
#+begin_src emacs-lisp
  (use-package calfw)
  ...
  (setq cfw:fchar-junction ?╬
    ...
    ;; Function defined in secret.el following specs from https://github.com/kiwanami/emacs-calfw
  (add-to-list 'load-path "~/.emacs.d/secret.el")
  (load-file "~/.emacs.d/secret.el")
  (define-key org-mode-map (kbd "C-c a") '(lambda () (interactive) (secret/calendar)))
#+end_src
*** Calendar
    #+begin_src emacs-lisp
      (defun todo/done ()
