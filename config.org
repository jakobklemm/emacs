...
*** Options
   ...
   #+begin_src emacs-lisp
     (setq org-todo-keywords
           '((sequence "TODO(1)" "CURRENT(2)" "BLOCKED(3)" "|" "DONE(y)")
             (sequence "LONG(q)" "RESEARCH(w)" "FIXING(e)" "|" "DONE(c)")
             (sequence "SCHULE(s)" "PROGRESS(d)" "QUICK(f)" "|" "DONE(x)")))
   #+end_src
** Tags
    ...
    (setq org-agenda-custom-commands
         ...
         '(
           (:name "Important"
                  ...
                  :priority "A"
                  ;;:time-grid t
                  :face (:background "#8e933a")
                  :order 0
                  )
           (:name "Schule"
                  :tag ("schule" "Progress" "Quick")
                  :face (:background "#13a1da")
                  :order 1
                  )
           (:name "Prüfungen"
                  :tag ("Prüfungen")
                  :face (:background "#93f1fa")
                  :order 2
                  )
           (:name "Projects"
                  :tag ("Erebos" "Warrick")
                  :face (:background "#34fb99")
                  :order 3
                  )
           (:priority<= "B"
                        :order 4
