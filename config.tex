...
\end{verbatim}
\subsection{Magit}
\label{sec:org7de8e1f}
Use \texttt{magit} with some additional packages.
\begin{verbatim}
(use-package magit
  :ensure t
  :config
...
\end{verbatim}
\subsection{LSP}
\label{sec:orgcd6e6c6}
Setup \texttt{LSP} \& \texttt{LSP-UI}, mainly for Elixir, later also for Rust.
\begin{verbatim}
...
\end{verbatim}
\subsection{Refile}
\label{sec:org48a3b75}
Use quick refile helpers for current \texttt{GPS} implementation.
\begin{verbatim}
